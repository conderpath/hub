...
class apiDataFilter {
    constructor(apiObj = {}) {
        ...
        console.log('this.apiConf-------', this.apiConf)
    ...
    async request({
        ...
        const options = {
            ...
            ...this.checkMethod({method, params, data,type,parentCode, otherData })
        };
     ...
     * @returns {{}}
     */
    checkMethod({method, params, data,type,parentCode, otherData}) {
        let options = {}
        if ((method === 'post' || method === 'put' || method === 'delete') && Object.keys(params).length === 0) {
            options.data = dataCommonInsert(data,type,parentCode, otherData);
