...
import { KEY_COMPONENT_NAME, DIC_SPLIT, ARRAY_LIST, DATE_LIST, INPUT_LIST, ARRAY_VALUE_LIST, MULTIPLE_LIST, SELECT_LIST } from './variable';
import { detailDataType, findObject, createObj } from './utils';
...
export const getComponent = (type, component) => {
  ...
  if (!validatenull(component)) {
    ...
    result = 'input-' + type;
  }else if (['tabs','card','borderCard'].includes(type)){
    result = 'tabs';
 ...
 * 动态获取组件
 */
export const getComponentTemp = (type, component) => {
