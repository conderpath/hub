...
export const KEY_COMPONENT_NAME = 'ac-';

export const B_KEY_COMPONENT_NAME = 'acb-';
...
export const ARRAY_VALUE_LIST = ARRAY_LIST.concat(['upload', 'dynamic', 'map', 'checkbox', 'cascader', 'dynamic', 'timerange', 'monthrange', 'daterange', 'datetimerange', 'dates','form-crud']);
